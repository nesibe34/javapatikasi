...
public class BattleLocation extends Location{
    ...
    public boolean onLocation() {
        if (this.getName().equals("Maden")){
            int obsNum=this.randomObstacleNumberForMine();
            ...
            if(selectCase.equals("S") && combatMine(obsNum)) {
                System.out.println(this.getName()+" daki tüm canavarları yendiniz.");
                return true;
            }
            ...
            if (selectCase.equals("S") && combat(obsNum)) {
                ...
                this.getPlayer().getInventory().gainAward(this.getName());
                return true;
            }
            if (this.getPlayer().getHealth() <= 0) {
                System.out.println("Öldünüz.");
    ...
    public boolean combat(int obsNum){
        for (int i=1;i<=obsNum;i++){
            ...
            if (this.getObstacle().getHealth()<this.getPlayer().getHealth()){
                ...
                System.out.println(this.getObstacle().getCoin()+" altın kazandınız.");
    ...
    public boolean combatMine(int obsNum){
        for (int i=1;i<=obsNum;i++){
            this.getObstacle().setHealth(this.getObstacle().getOrjHealth());
            playerStats();
            obstacleStats(i);
            ...
            if (this.getObstacle().getHealth()<this.getPlayer().getHealth()){
                System.out.println("Canavarı yendiniz.");
                this.getPlayer().getInventory().giveAward();
                this.getPlayer().setMoney(this.getPlayer().getMoney()+this.getPlayer().getInventory().getCoin());
            }else{
                return false;
            }
        }
    ...
    public void obstacleStats(int i){
        ...
        System.out.println("Para : "+this.getObstacle().getCoin());
        System.out.println("-------------------------");
    ...
    public int randomObstacleNumberForMine(){
        Random r=new Random();
        return r.nextInt(this.getMaxObstacle())+1;
    }
